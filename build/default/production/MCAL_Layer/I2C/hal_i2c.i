...
# 11 "MCAL_Layer/I2C/../Interrupt/../std_libraries.h"
...
# 11 "MCAL_Layer/I2C/../Interrupt/../std_libraries.h" 2
...
# 12 "MCAL_Layer/I2C/../Interrupt/../GPIO/hal_gpio.h"
# 1 "MCAL_Layer/I2C/../Interrupt/../GPIO/hal_gpio_cfg.h" 1
# 12 "MCAL_Layer/I2C/../Interrupt/../GPIO/hal_gpio.h" 2
...
# 31 "MCAL_Layer/I2C/../Interrupt/../GPIO/../mcal_std_types.h"
...
# 14 "MCAL_Layer/I2C/../Interrupt/../GPIO/hal_gpio.h" 2

# 1 "MCAL_Layer/I2C/../Interrupt/../GPIO/../../MCAL_Layer/device_config.h" 1
# 15 "MCAL_Layer/I2C/../Interrupt/../GPIO/hal_gpio.h" 2
# 30 "MCAL_Layer/I2C/../Interrupt/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
static __attribute__((inline)) void MSSP_I2C_Interrupt_Configurations(const mmsp_i2c *i2c);
...
std_ReturnType MSSP_I2C_INIT(const mmsp_i2c *i2c){
    ...
    if(i2c == ((void*)0)){
        ...
        (SSPCON1bits.SSPEN = 0);
        if(i2c->cfg.mode == 0x00){
            (SSPCON1bits.SSPM = 0x08);
            if(i2c->cfg.master_recieve_mode == 0x01){
            ...
            SSPADD = (uint8)((((i2c->i2c_clock) * 4) / 4000000) - 1);
        }
        else if(i2c->cfg.mode == 0x01){
            if(i2c->cfg.general_call == 0x01){
                SSPCON2bits.GCEN = 1;
            }
            else if(i2c->cfg.general_call == 0x00){
                SSPCON2bits.GCEN = 0;
            }
            else{ }
            SSPCON1bits.WCOL = 0;
            ...
            (SSPCON1bits.CKP = 1);
            (SSPCON1bits.SSPM = i2c->cfg.i2c_mode_cfg);
        }
        else{ }
        if(i2c->cfg.slew_rate == 0x01){
            (SSPSTATbits.SMP = 1);
        }
        else if(i2c->cfg.slew_rate == 0x00){
            (SSPSTATbits.SMP = 1);
        }
        else{ }
        if(i2c->cfg.smbus == 0x01){
            (SSPSTATbits.CKE = 1);
        }
        if(i2c->cfg.smbus == 0x00){
            (SSPSTATbits.CKE = 1);
        }
        else{ }
