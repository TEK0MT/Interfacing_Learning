...
# 31 "MCAL_Layer/SPI/../GPIO/../mcal_std_types.h"
...
# 1 "MCAL_Layer/SPI/../GPIO/../../MCAL_Layer/device_config.h" 1
# 15 "MCAL_Layer/SPI/../GPIO/hal_gpio.h" 2
# 30 "MCAL_Layer/SPI/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 42 "MCAL_Layer/SPI/../Interrupt/mcal_interrupt_config.h"
typedef enum{
    LOW_PRIORITY = 0,
    HIGH_PRIORITY
}interrupt_priority;
...
static __attribute__((inline)) void MSSP_SPI_Interrupt_Configurations(const spi_t *spi);
...
static void spi_idle_state(const spi_t *spi){
    if(spi->idle_state == 0x01){
        (SSPCON1bits.CKP = 1);
    }
    else if(spi->idle_state == 0x00){
        (SSPCON1bits.CKP = 0);
    }
    else{ }
}
...
static void spi_transimt_logic(const spi_t *spi){
    if(spi->transmit_logic == 0x01){
        (SSPSTATbits.CKE = 1);
    }
    else if(spi->transmit_logic == 0x00){
        (SSPSTATbits.CKE = 0);
    }
    else{ }
}
